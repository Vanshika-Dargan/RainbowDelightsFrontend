...
import ProductsData from "../../ProductsData"; // Ensure this path matches your project structure
import ModalPopup from '..//ModalPopup/ModalPopup'; // Adjust this path to where your ModalPopup component is located
import './Navbar.css';
...
export default function Navbar() {
    ...
    const [isModalOpen, setIsModalOpen] = useState(false); // For ModalPopup
                    ...
                    <div className="flex justify-between items-center py-3">
                        ...
                        <div className="flex items-center space-x-4 relative">
                            ...
                            <div className="relative" ref={dropdownRef}>
                                <div onClick={() => setIsDropdownOpen(!isDropdownOpen)} className="flex items-center font-color hover:cursor-pointer">
                            ...
                            <Link to="/cart" className="flex items-center font-color relative">
                                ...
                                {cartItemCount > 0 && (
                                    <span className="flex absolute -top-2 -right-2 justify-center items-center bg-red-500 text-white text-xs font-bold rounded-full h-4 w-4">
                                        {cartItemCount}
                                    </span>
                                )}
                            </Link>
