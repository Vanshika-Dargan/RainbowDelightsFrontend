...
export const Sidebar = ({ setIsProductClicked }) => {
    ...
    return (
        <>
            <aside id='default-sidebar' className='fixed w-64 h-screen top-0 left-0 z-40 siderbar-color'>
                ...
                <div>
                    <ul>
                        ...
                        <li className='mb-1 text-lg'>
                            <div className='flex items-center p-2 ml-6 mr-2' onMouseOver={handleLiMouseOver} onMouseLeave={handleLiMouseLeave}>
                                <svg className="w-5 h-5 das-icons" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
