    ...
    return (
      <div className="max-w-64 rounded-2xl overflow-hidden shadow-2xl border-2 border-black relative">
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center">
          <a href="#"><span className="text-2xl font-extrabold text-white">See More</span></a>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-64 rounded-2xl overflow-hidden shadow-2xl border-2 border-black">
        ...
        <div className="px-6 py-3">
          <div className="flex justify-between items-center">
            <div className="font-semibold text-xl colorname ">{name}</div>
            <div className="font-semibold text-2xl colorprice">{price}</div>
          </div>
        </div>
      </div>
    </a>
